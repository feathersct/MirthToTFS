...
namespace MirthConnectFX
{
    public class EventsService : ServiceBase, IEventsService
    {
                              ...
                              string serverId = "")
        {
            ...
            // Add Url Datat
            if (startDate.HasValue)                 request.AddUrlData("startDate", startDate.Value.ToString("yyyy-MM-ddTHH:mm:ss.fff") + "-0400");
            if (endDate.HasValue)                   request.AddUrlData("endDate", endDate.Value.ToString("yyyy-MM-ddTHH:mm:ss.fff") + "-0400");
